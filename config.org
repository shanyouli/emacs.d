...
(defun insert-datetime ()
  ...
  (let ((my-n-format "%Y-%m-%d %H:%M:%S"))
    (insert (my-n))))
#+end_src
- better toggle input method, 参考[fn:3]
#+begin_src emacs-lisp
;;;###autoload
...
*** rimel
一款基于 liberime 的包，比 emacs-rime 更轻量的中文输入法[fn:4], 更多讨论[[https://emacs-china.org/t/liberime-emacs-rime/31225][emacs-china rimel 发布]]
#+begin_src emacs-lisp :tangle "packages.el"
...
#+end_src
*** eat
在 macos 打开 eat 出现类似 不支持 eat-truecolor 的错误请执行 M+x ~eat-compile-terminfo~[fn:5]
#+begin_src emacs-lisp :tangle "packages.el"
...
[fn:1] https://github.com/rejeep/f.el

[fn:2]https://paste.sr.ht/~zyd/d6350d65005b6547882548c35923cfddafcfcd65

[fn:3] https://github.com/redguardtoo/emacs.d/blob/3da56451132e10ed5f925aa32adff19185bff705/lisp/init-chinese.el#L8

[fn:4] https://github.com/jixiuf/rimel

[fn:5] https://codeberg.org/akib/emacs-eat/issues/45
