...
*** rimel
一款基于 liberime 的包，比 emacs-rime 更轻量的中文输入法
#+begin_src emacs-lisp :tangle "packages.el"
...
#+end_src
*** eat
在 macos 打开 eat 出现类似 不支持 eat-truecolor 的错误请执行 M+x ~eat-compile-terminfo~[fn:3]
#+begin_src emacs-lisp :tangle "packages.el"
...
[fn:3] https://codeberg.org/akib/emacs-eat/issues/45
