...
则转变为 `evil-insert-state'"
  ...
  (defadvice! +rime-input-method-a (&rest _)
    :before #'activate-input-method
    (when (and (daemonp)
               (equal default-input-method "rime"))
      (if (and (bound-and-true-p rime-posframe-buffer)
          ...
          (setq-local rime-show-candidate 'posframe)
        (setq-local rime-show-candidate 'popup))))
  )
(after! evil
  ;; 激活时
